...
export function Logo(): JSX.Element {
  return (
    <span class="text-center font-sans font-black tracking-tighter uppercase text-nowrap">
      Splika<span class="inline-block text-primary origin-bottom-left rotate-6">
        n
      </span>
    </span>
  );
